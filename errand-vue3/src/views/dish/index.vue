...
<template>
  <el-card>
    <div class="horizontal">
      ...
      <el-select size="large" class="input" clearable v-model="pageData.categoryId" placeholder="选择商品分类">
    ...
    <el-table class="table_box" ref="multiTableRef" :data="dishList" stripe @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="detail" label="商品描述" width="200px" align="center" />
