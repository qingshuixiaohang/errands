...
<template>
  ...
  <el-card>
    ...
    <el-form :model="form" :rules="rules" ref="addRef">
      <el-form-item label="组合名称" :label-width="formLabelWidth" prop="name">
        <el-input v-model="form.name" autocomplete="off" placeholder="例：超值午餐" />
      </el-form-item>
      ...
      <el-form-item label="商品描述" :label-width="formLabelWidth" prop="detail">
        <el-input v-model="form.detail" autocomplete="off" type="textarea" placeholder="描述一下这个商品..." />
      </el-form-item>
      <el-form-item label="销售价" :label-width="formLabelWidth" prop="price">
        <el-input v-model="form.price" autocomplete="off" placeholder="例：15" />
      </el-form-item>
      <el-form-item label="所属分类" :label-width="formLabelWidth" prop="categoryId">
        <el-select clearable v-model="form.categoryId" placeholder="选择商品分类">
