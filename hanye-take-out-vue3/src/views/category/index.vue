...
<template>
  <el-card>
    <div class="horizontal">
      <el-input size="large" class="input" v-model="pageData.name" placeholder="请输入商家名" />
      <el-button size="large" class="btn" round type="success" @click="init()">查询商家</el-button>
      ...
      <el-table-column label="操作" width="250px" align="center">
        ...
        <template #default="scope">
          ...
          <el-button @click="change_btn(scope.row)" plain :type="scope.row.status === 1 ? 'danger' : 'primary'">
            {{ scope.row.status === 1 ? '隐藏' : '展示' }}</el-button>
